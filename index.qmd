...
::: {.column width="50%"}
- Lots of R Groups: PDX-R, Oregon State University, Seattle-R, Vancouver-R
...
:::{.column}
![](images/CascadiaRConf-Intro.png){width=600}
:::
::::

- Everyone did their part and it all came together

## Asynchronous Tools that helped make the conference

::::{.columns}
:::{.column width="30%"}
- Trello
- Slack
- Allowed us to make Asynchronous Decisions
:::
:::{.column width="70%}
![](images/trello.png)
:::
...
Call for Proposals - 1 month from start
...
::: {.fragment}
- **Caitlin Hudon**	
    - [*NULL: When Missing Data is Valuable*](https://docs.google.com/presentation/d/1tq1NKuA_OrPEWjT63yi2Oq-KtXRsHnHawByw6-a_Y6w/edit#slide=id.p)
:::
...
- Get out of Portland {{< fa-solid fa-square-check >}}
- Keep values upheld  {{< fa-solid fa-square-check >}}
- Encourage participation from all   {{< fa-solid fa-square-check >}}
    - (even a 5 minute talk on something you learned! we are all learners)
- Continue to learn how to increase diversity, accessibility, reach underrepresented groups  {{< fas fa-check-square >}}
...
- OHSU, Posit, and R-Consortium and other sponsors
- Cascadia-R Organizers (past and present)
- Amazing Cascadia-R audience and speakers
- You!
