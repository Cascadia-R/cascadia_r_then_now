...
![Wide picture showing 253 people](images/IMG_4201.JPG)
...
ggplot(career_count) + aes(x=career, y=n, fill=career) + geom_col() +
...
responses3 |>
  ...
  ggplot() + aes(x=industry, y=n, fill=industry) + geom_col() +
  geom_text(aes(label=industry), vjust=-2.5, hjust=0.1, angle=45) +
    theme_minimal() +
  theme(legend.position = "none", axis.text.x = element_blank() ) +
